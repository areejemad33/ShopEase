...
//   // نجيب الإيميل الحالي اللي عامل لوج ان
...
//         await prefs.setString("profileImage", pickedFile.path); // << هنا
...
//                   CircleAvatar(
//                     radius: 60,
//                   backgroundImage: (profileImagePath != null && profileImagePath!.isNotEmpty && File(profileImagePath!).existsSync())
...
//               label: Text(S.of(context).myOrders, style: const TextStyle(color: Colors.white, fontSize: 16)),
//             ),
...
//   label: Text(
//     S.of(context).logout, // هنا استخدمنا الترجمة
